...
def delete_resident(resident_id):
    ...
    kv.set('flats', flats)
    # Optional: Adjust current_turn_index if needed
...
def trigger_reminder():
    """
    This endpoint sends the weekly reminder.
    It can be triggered by a GET request (from the cron job) 
    ...
    try:
        ...
        if custom_message_body:
            ...
            message = f"Hi {person_on_duty['name']}! Just a friendly reminder that it's your turn to take out the dustbin today. Thank you!"
